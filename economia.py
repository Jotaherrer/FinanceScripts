...
plt.plot(tcrm)
plt.title('Tipo de cambio multilateral')
plt.show()

#%%
## TIPO DE CAMBIO VENDEDOR BANCO NACION
tc_bna = mh.get_data(['168.1_T_CAMBIOR_D_0_0_26'], start_date='2008-01-01', limit= 1000)
tc_bna.plot()

## TIPO DE CAMBIO A3500
tc3500 = mh.get_data(['175.1_DR_REFE500_0_0_25'], start_date='2018-01',
                   limit = 1000)
tc3500.plot()
tc3500.pct_change()
...
# Registro de reservas internacionales:
